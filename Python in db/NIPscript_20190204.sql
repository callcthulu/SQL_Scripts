...
SELECT DISTINCT SUBSTRING(BuyerIdentificationNumber,3,400) AS Nip FROM [dbo].[JPK_VatRegisters] WHERE BuyerIdentificationNumber LIKE 'PL%';*/

EXECUTE sp_execute_external_script
    @language = N'Python'
    , @input_data_1 = N'SELECT SUBSTRING(Number,3,400) AS NIP FROM da.TaxIDs WHERE Type = 1'
